...
write.csv(rbindlist(phloops), "scripts/data/ph_plast_h_FBL.csv")
...
write.csv(rbindlist(plast_medgrowthloops), "scripts/data/plast_medium_growth_h_FBL.csv")
...
write.csv(rbindlist(np_medgrowthloops), "scripts/data/np_medium_growth_h_FBL.csv")
...
write.csv(rbindlist(plast_ox), "scripts/data/plast_mg_c_h_FBL.csv")
...
write.csv(rbindlist(plast_aero), "scripts/data/plast_aero_h_FBL.csv")
...
write.csv(rbindlist(plast_juice), "scripts/data/plast_juice_h_FBL.csv")
...
write.csv(rbindlist(plast_temptr), "scripts/data/plast_temptr_h_FBL.csv")
...
write.csv(rbindlist(plast_stringent), "scripts/data/plast_stringent_h_FBL.csv")
...
write.csv(rbindlist(plast_stress), "scripts/data/plast_stress_h_FBL.csv")
...
write.csv(rbindlist(nonplast_FBL), "scripts/data/plast_genes_h_FBL.csv")
...
nonplast_h_FBL <- mclapply(nonplast_genes, function(gene) {
  cc <- FBL.type(list(E_coli_mat), cutoff = cutoff, target = which(colnames(E_coli_mat)==gene), randomFF=FALSE)
  return(cc)
}, mc.cores = 50)
write.csv(rbindlist(nonplast_h_FBL), "scripts/data/nonplast_h_FBL.csv")
...
write.csv(rbindlist(nonplast_FBL), "scripts/data/all_genes_h_FBL.csv")
