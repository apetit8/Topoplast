...
plot(PLD[,1], PLD[,2], log = "y", col=alpha("darkblue", 0.5), ylab="", xlab="", xlim=c(0,30), pch=19)
...
polygon(x=c(-5, -5, 40, 40),  y=c(50000, 0.01, 0.01, 50000),  col="cornsilk", border=NA, xpd=TRUE)
axis(side = 1)
#axis(side = 2)
