...
ifelse(!dir.exists(file.path("simul/2g")), dir.create("simul/2g"), FALSE)
...
################################################################################
param.dir <- file.path("templates/10g_a0.15")
ifelse(!dir.exists(file.path("simul/10g_a0.15")), dir.create("simul/10g_a0.15"), FALSE)#burning_andreas folder
cache.dir <- normalizePath(file.path("simul/10g_a0.15"))
...
max <- 0.85 #max environment
#
launchfilename <- "launchers/10g_a0-15-launch.sh"
##########################
# Generate all simulations
# A simulation is characterized by a name, a parameter file, and an extended parameter file with bottleneck etc. information
# Simulations involve the creation of many small files (new parameters every generation due to plasticity). This is largely
...
################################################################################
param.dir <- file.path("templates/30g")
ifelse(!dir.exists(file.path("simul/30g")), dir.create("simul/30g"), FALSE)#burning_andreas folder
cache.dir <- normalizePath(file.path("simul/30g"))
...
max <- 0.85 #max environment
#
launchfilename <- "launchers/30g-launch.sh"
##########################
# Generate all simulations
# A simulation is characterized by a name, a parameter file, and an extended parameter file with bottleneck etc. information
# Simulations involve the creation of many small files (new parameters every generation due to plasticity). This is largely
