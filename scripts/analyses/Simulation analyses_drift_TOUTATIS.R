...
Drift   <- FFL.type2(topo_all, edges1 = 2, edges2 = 1, target= 2)
...
Drift <- loops_n.count(topo_all, edges1 = 2, edges2 = 1, target= 2)
...
Drift <- FFL.type2(topo_all, edges1 = 2, edges2 = 2, target= 2)
...
Drift <- loops_n.count(topo_all, edges1 = 2, edges2 = 2, target= 2)
...
Drift <- FBL.type(topo_all, edges = edges, target= 2)
...
Drift <- FBL_n.count(topo_all, edges=edges, target= 2)
