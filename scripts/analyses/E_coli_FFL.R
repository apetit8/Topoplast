...
plast_stress <- e_coli_prep_analyses(stress_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
#
plast_medgrowthloops <- e_coli_prep_analyses(medgrowth_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
#
np_medgrowthloops <- e_coli_prep_analyses(non_envir_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
plast_mg_c  <- e_coli_prep_analyses(mg_c_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
plast_ox <- e_coli_prep_analyses(ox_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
plast_aero <- e_coli_prep_analyses(aero_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
plast_juice <- e_coli_prep_analyses(juice_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
plast_temptr <- e_coli_prep_analyses(temptr_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
...
plast_stringent <- e_coli_prep_analyses(stringent_genes1, g, E_coli_mat, fun="FFL", edges1=edges1, edges2=edges2, cores=1, from = from)
